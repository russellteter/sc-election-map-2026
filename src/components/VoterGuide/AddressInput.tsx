...
export default function AddressInput({ onSubmit, isLoading, error }: AddressInputProps) {
  ...
  return (
    <div className="glass-surface rounded-lg p-6 animate-entrance">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              style={{
                ...
                // Use 16px min to prevent iOS zoom on focus
                fontSize: '16px',
              }}
              onFocus={(e) => {
      ...
      <p className="text-xs mt-3" style={{ color: 'var(--text-muted)' }}>
        Enter a complete street address including city and state. ZIP codes alone are not supported.
      </p>
    </div>
  );
}
